...
namespace PokemonReviewApp.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        [HttpGet("{countryId}")]
        [ProducesResponseType(200, Type = typeof(Country))] // success
        ...
        {
            if (countryCreate == null) // user sends nothing
                return BadRequest(ModelState);
            ...
            var country = _countryRepository.GetCountries().Where(c => c.Name.Trim().ToUpper() == countryCreate.Name.TrimEnd().ToUpper()).FirstOrDefault(); // checking if there is an instance
